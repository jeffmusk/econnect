    ...
    return (
        <ScrollView >
            ...
            <Text style={styles.category}>Compostaje</Text>
                ...
                <Text style={styles.description}>Se trata de un producto natural, sin compuestos químicos y libre de patógenos. En muchos casos actúa como bactericida y fungicida.
                </Text>

                <Text style={styles.description}>Efectos sobre los nutrientes de las plantas.   </Text>

                <Text style={styles.description}>Al ser un producto rico en nutrientes y macronutrientes, se convierte en un excelente abono para las plantas. 
                </Text>
